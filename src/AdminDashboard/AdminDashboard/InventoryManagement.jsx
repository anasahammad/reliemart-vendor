...
const InventoryManagement = () => {
  ...
  const fetchInventoryAndProfit = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/admin/inventory/reseller`, {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Inventory Management & Monthly Profit From Reseller</h1>
